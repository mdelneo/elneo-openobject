                ...
                if intervention_product.product_id:
                    ...
                    if intervention_product not in products_of_moves.mapped('intervention_product_id'):
                        ...
                        if move_qty != interv_qty:
                            products_of_moves.filtered(lambda r:r.intervention_product_id.id==intervention_product.id).sudo().write({'product_qty':interv_qty, 'product_uos_qty':interv_qty})
                            original_qty = 0
                            ...
                            diff_qty.append((products_of_moves.filtered(lambda r:r.intervention_product_id.id==intervention_product.id), interv_qty-original_qty, products_of_moves[intervention_product.id].sale_line_id.id))    
