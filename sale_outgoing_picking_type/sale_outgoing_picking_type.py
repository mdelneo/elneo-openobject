...
class procurement_order(models.Model):
    ...
    def _run_move_create(self, procurement):
        ...
        if res['picking_type_id']:
            ...
            if procurement.location_id.usage == 'customer' and picking_type.code == 'outgoing' and sale_line and sale_line.order_id and sale_line.order_id.outgoing_picking_type:
